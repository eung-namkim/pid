...
int fcn_adc( double SenInRange, int m_AdcR, double m_ys)
{
        int adc_result = 0;
        adc_result = (int)( ((double)m_AdcR) * m_ys / SenInRange);
        return adc_result;
}
//_____________________________________________________________________________________________________________________
...
double fcn_s_64( double m_SenInRange, int m_AdcR, double m_SamT, int m_AdcOut, int i_D_ref, double m_kp, double m_ki, double m_kd, double m_PWM_DuraionT, double m_PWM_IOclkT)
{
        ...
        //decoder
        _64r       = (m_SenInRange * i_D_ref) / ((double)m_AdcR);
        _64yrn     = m_SenInRange * m_AdcOut / ((double)m_AdcR);
        _64en0     = _64r  - _64yrn;
...
float fcn_s_32( float m_SenInRange, int m_AdcR, float m_SamT, int m_AdcOut, int i_D_ref, float m_kp, float m_ki, float m_kd, float m_PWM_DuraionT, float m_PWM_IOclkT)
{
        float _32en0 = 0;  
        float _32r = 0;               
        float _32yrn = 0;    
        ...
        //decoder
        _32r       = (m_SenInRange * i_D_ref) / ((float)m_AdcR);
        _32yrn     = (m_SenInRange * m_AdcOut) / ((float)m_AdcR);
        _32en0     = _32r - _32yrn;
...
float fcn_s_ou( float m_SenInRange, int m_AdcR, float m_SamT, int m_AdcOut, int i_D_ref, int m_kp, int m_ki, int m_kd, float m_PWM_DuraionT, float m_PWM_IOclkT)
{
...
double fcn_d_64( double m_SenInRange, int m_AdcR, double m_SamT, int m_AdcOut, int i_D_ref, double m_kp, double m_ki, double m_kd, double m_PWM_DuraionT, double m_PWM_IOclkT)
{
...
float fcn_d_32( float m_SenInRange, int m_AdcR, float m_SamT, int m_AdcOut, int i_D_ref, float m_kp, float m_ki, float m_kd, float m_PWM_DuraionT, float m_PWM_IOclkT)
{
...
float _ou_d_Mv1;
float fcn_d_ou( float m_SenInRange, int m_AdcR, float m_SamT, int m_AdcOut, int i_D_ref, float m_kp, float m_ki, float m_kd, float m_PWM_DuraionT, float m_PWM_IOclkT)
{
...
int main()
{
        ...
        const double SenInRange = 2 * M_PI;
        ...
        for( float t2=0; t2 < 1; t2 = t2 + SamT ) 
        {
                ...
                u32 = fcn_s_32( SenInRange, AdcR, SamT,AdcOut, i_D_ref, f_kp, f_ki, f_kd, PWM_DuraionT, PWM_IOclkT);
                cout << u32 << ",";
        }cout <<  "]";
        ...
        for( float t3=0; t3 < 1; t3 = t3 + SamT ) 
        {
                ...
                ys = fcn_sensor(yp);       
                AdcOut = fcn_adc( SenInRange, AdcR, ys);
                ou32 = fcn_s_ou(SenInRange, AdcR, SamT, AdcOut, i_D_ref, i_kp, i_ki, i_kd, PWM_DuraionT, PWM_IOclkT);
        ...
        for( double t5=0; t5 < 1; t5 = t5 + SamT ) 
        {
                ...
                u32 = fcn_d_32( SenInRange, AdcR, SamT, AdcOut, i_D_ref, f_kp, f_ki, f_kd, PWM_DuraionT, PWM_IOclkT);
        ...
        for( double t6=0; t6 < 1; t6 = t6 + SamT ) 
        {
                ...
                u32 = fcn_d_ou(SenInRange, AdcR, SamT, AdcOut, i_D_ref, i_kp, i_ki, i_kd, PWM_DuraionT, PWM_IOclkT);
                cout.precision(flo:: max_digits10);
                cout << u32 << ",";
        }cout <<  "]";    
